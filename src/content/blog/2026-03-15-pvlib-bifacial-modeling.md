...
| 地面类型 | 反照率 | 背面日辐照 | 双面增益 |
|---------|--------|-----------|---------|
| 深色沥青 | 0.15 | $0.77 \text{kWh/m}^2$ | **11.3%** |
| 浅色土壤 | 0.25 | $1.22 \text{kWh/m}^2$ | **18.0%** |
| 浅色混凝土 | 0.35 | $1.67 \text{kWh/m}^2$ | **24.5%** |
| 白色碎石 | 0.50 | $2.35 \text{kWh/m}^2$ | **34.3%** |
...
**年均双面增益：11.9%**，年总辐照从 2437 增加到 $2726 \text{kWh/m}^2$（+$289 \text{kWh/m}^2$）。
