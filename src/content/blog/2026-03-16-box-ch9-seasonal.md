...
| 符号 | 含义 | 例子 |
|------|------|------|
| $\phi_p(B)$ | 非季节 AR(p) | $(1 - \phi_1 B)$ |
| $\Phi_P(B^s)$ | 季节 AR(P) | $(1 - \Phi_1 B^{12})$ |
| $\nabla^d = (1-B)^d$ | 非季节差分 | $d = 1$ |
| $\nabla_s^D = (1-B^s)^D$ | 季节差分 | $D = 1, s = 12$ |
| $\theta_q(B)$ | 非季节 MA(q) | $(1 - \theta_1 B)$ |
| $\Theta_Q(B^s)$ | 季节 MA(Q) | $(1 - \Theta_1 B^{12})$ |
...
*📖 [Ch8 笔记](/blog/2026-03-16-box-ch8-diagnostics) | [返回教材目录](/textbook/) | 📝 [Box 时间序列系列](/blog/tags/时间序列)*
